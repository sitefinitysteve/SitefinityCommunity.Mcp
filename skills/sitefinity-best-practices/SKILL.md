...
| **sitefinity-react-vite8-guide** | The React 19 counterpart on the same classic MVC stack - React root lifecycle inside the page editor, `mountWidget` + Sentry error boundary, hashed-entry chunk loading, bun/oxlint/oxfmt toolchain, migrating widgets from Vue. Not for the Core Renderer. |
